...
const SecureVariablesFieldComponent = (
...
export const SecureVariablesInputFieldExtension = scaffolderPlugin.provide(
  createScaffolderFieldExtension({
    name: 'SecureVariablesInput',
    component: SecureVariablesFieldComponent,
  }),
);
